...
function setLang(lang) {
  ...
  // Cover images — switch by language
  // Front : assets/images/cover-fr.jpg | cover-en.jpg | cover-nl.jpg
  // Full  : assets/images/cover-full-fr.jpg | cover-full-en.jpg | cover-full-nl.jpg
  ...
  if (coverImg) {
    const newSrc = `assets/images/cover-${lang}.jpg`;
    if (coverImg.src !== newSrc) {
  ...
  if (coverBackImg) {
    const newBack = `assets/images/cover-full-${lang}.jpg`;
    if (coverBackImg.src !== newBack) {
      coverBackImg.onerror = function() { this.style.display = 'none'; };
      coverBackImg.onload  = function() { this.style.display = ''; };
      coverBackImg.src = newBack;
    }
  }
